...
VALUES ('Java', 'Work with our dudes',  'https://miro.medium.com/max/276/1*nftoTHMTibmPs4gpgvhEeQ.png'), 
('C++', 'dont use it', 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/ISO_C%2B%2B_Logo.svg/1200px-ISO_C%2B%2B_Logo.svg.png'),
('C', 'C! its for you and its for me', 'https://sdtimes.com/wp-content/uploads/2016/06/0615.sdt-microsoft.jpeg'),
('Python', 'Snek', 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Python-logo-notext.svg/200px-Python-logo-notext.svg.png'),
('Web Languages (HTML, CSS, JavaScript, and more!)', 'wow its like what Im taking now', 'https://images.pexels.com/photos/1148820/pexels-photo-1148820.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500')";
...
<br><h1 style="text-align:center">Language Courses</h1>
<div style="text-align:center">
    ...
    if ($rows > 0)
    {
        while($row = mysqli_fetch_assoc($result))
        {
            ...
            echo "<img src='$imgUrl' height='350'>";
